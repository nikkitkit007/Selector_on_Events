from quart import request, make_response, redirect, url_for
...
async def set_tokens(access_token: str, expires_in: int, refresh_token: str, refresh_expires_in: int):
...
async def login():
    ...
    return await set_tokens(access_token=access_token,

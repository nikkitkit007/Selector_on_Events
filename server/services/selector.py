...
class Selector:
    ...
    @staticmethod
    async def get_user_score(users_ids: list, local_session: session):
        users_score = {}
    ...
    @staticmethod
    async def select_users_on_event(event_id: int, local_session: session):
        ...
        if users_want:
            ...
            users_want_with_score = await Selector.get_user_score(users_want, local_session)

...
class TestNews:
    def test_add(self, get_base_url, get_one_news):
        ...
        response = requests.post(get_base_url + method, json=news)
    ...
    def test_get(self, get_base_url, get_one_news):
        ...
        response = requests.get(get_base_url + method, params=news_id_dict)
    ...
    def test_delete(self, get_base_url, get_one_news):
        ...
        response = requests.delete(get_base_url + method, json=news_id_dict)
        assert response.status_code == status.HTTP_200_OK
